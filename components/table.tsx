...
export const Table = ({ className }: { className?: string }) => {
    ...
    return (
        <div className={cn('bg-linear-to-b to-background ring-border-illustration relative mx-auto max-w-4xl rounded-2xl border border-transparent from-zinc-50 p-6 shadow-md shadow-black/10 ring-1', className)}>
            <div className="mb-4">
